...
script args. A conda environment with Jupyter installed is also required (either already active,
or via `CONDA_ENV`) — Claude will ask which one to use if it can't tell. For a durable setup, copy
